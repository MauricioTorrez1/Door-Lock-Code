...
HD_PWD='C:/Users/under/OneDrive/Escritorio/FESC/2026-1/Diseo de Sistemas Digitales/Door_Lock_Code/Door_Lock_Code.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Door_Lock_Code.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Door_Lock_Code.tcl -notrace
