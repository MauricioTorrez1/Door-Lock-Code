...
HD_PWD='C:/Users/under/OneDrive/Escritorio/FESC/2026-1/Diseo de Sistemas Digitales/Door_Lock_Code/Door_Lock_Code.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Door_Lock_Code.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Door_Lock_Code.tcl
