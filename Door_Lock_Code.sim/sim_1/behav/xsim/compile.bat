...
REM
REM Generated by Vivado on Tue Sep 23 17:29:05 -0600 2025
...
echo "xvlog --incr --relax -L uvm -prj Door_Lock_Code_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj Door_Lock_Code_tb_vlog.prj -log xvlog.log
